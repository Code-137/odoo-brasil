...
class AccountMove(models.Model):
        ...
        for line in invoice_lines:
            ...
            vals = {
                ...
                "icms_valor_credito": round(
                    line.price_total * fiscal_pos.icms_aliquota_credito / 100, 2
                ),
                # - IPI -
                "ipi_cst": "99",
                ...
                "cofins_valor": round(
                    line.price_total * cofins.tax_line_id.amount / 100, 2
                ),
                ...
                "csll_valor": round(
                    line.price_total * csll.tax_line_id.amount / 100, 2
                ),
                ...
                "irpj_valor": round(
                    line.price_total * irpj.tax_line_id.amount / 100, 2
                ),
    ...
    def _prepare_eletronic_doc_vals(self):
        ...
        vals.update(
            {"valor_servicos": total_servicos, "valor_produtos": total_produtos,}
        )
        return vals
    ...
    def action_create_eletronic_document(self):
        for move in self:
            ...
            services = move.invoice_line_ids.filtered(
    ...
    def action_post(self):
        moves = self.filtered(
            lambda x: x.l10n_br_edoc_policy == "directly" and x.type != "entry"
        )
