...
class NfeMde(models.Model):
    ...
    company_id = fields.Many2one(
        "res.company", string=u"Empresa", default=_default_company, readonly=True
    )
    currency_id = fields.Many2one(
        related="company_id.currency_id", string=u"Moeda", readonly=True
    )
    ...
    numero_sequencial = fields.Char(string=u"Número Sequencial", readonly=True, size=20)
    ...
    tipo_operacao = fields.Selection(
        [("0", "Entrada"), ("1", "Saída")], string=u"Tipo de Operação", readonly=True
    )
    ...
    situacao_nfe = fields.Selection(
        ...
        string=u"Situação da NF-e",
        readonly=True,
    )
    state = fields.Selection(
        string=u"Situação da Manifestação",
        readonly=True,
        selection=[
            ("pending", "Pendente"),
